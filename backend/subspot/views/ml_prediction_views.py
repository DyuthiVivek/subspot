...
ordinal_mapping = {
    "Low": 0, "Short": 0, "Rare": 0, "Poor": 0,
    "Medium": 1, "Moderate": 1, "Intermediate": 1, "Average": 1,
    "High": 2, "Long": 2, "Frequent": 2, "Good": 2,
    "Very High": 3, "Very Long": 3, "Very Frequent": 3, "Excellent": 3
}
...
class PredictionView(View):
    def post(self, request):
        try:
            ...
            try:
                subscription = Subscription.objects.get(service_name=service_name, owner=user)
            ...
            input_data = {
                "ViewingHoursPerWeek_Bucket": ordinal_mapping[viewing_hours],
                "AverageViewingDuration_Bucket": ordinal_mapping[avg_viewing_duration],
                "ContentDownloadsPerMonth_Bucket": ordinal_mapping[content_downloads],
                "SupportTicketsPerMonth_Bucket": ordinal_mapping[support_tickets],
                "AccountAge_Bucket": ordinal_mapping[account_age_bucket],  # Now calculated
                "MonthlyCharges_Bucket": ordinal_mapping[monthly_charges_bucket],
                "UserRating_Bucket": ordinal_mapping[user_rating],
                "TotalCharges_Bucket": ordinal_mapping[total_charges_bucket],
